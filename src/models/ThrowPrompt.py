...
class PromptInterface:
    def __init__(self):
        ...
        self.fruent_state = self.get_text_from_txt("./config/prompt/request_summary.txt")
        self.config = self.get_conf_from_json("./config/settings_data.json")
    ...
    def get_conf_from_json(self, dir: str):
        with open(dir, 'r', encoding='utf-8') as file:
